...
class SEIRDiseaseScheduler(DiseaseSchedulerBase):
    ...
    def get_disease_schedule(self, base_timestep=0):
        ...
        if self.np_random.rand() < self.prob_infection:
            ...
            # Case when the patient doesnt get an infection
            return []
...
if __name__ == "__main__":
    disease_scheduler = SEIRDiseaseScheduler(prob_infection=1.0)
    disease_scheduler = SimpleSEIRDiseaseScheduler(prob_infection=1.0)
    for k in range(100):
